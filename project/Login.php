  ...
  <div class="container">
    <div class="form">
      <div class="btn">
        ...
        <button class="loginBtn"><h2 style="font-family: 'Satisfy', cursive;
font-family: 'Tillana', cursive;font-size: 30px;">LOG IN</h2></button>
      </div>
      <!--
      ...
      <?php include('errors.php'); ?>
        ...
        <div class="formGroup">
          <span class="message" style="color:rgb(10, 136, 43);font-weight: bold;display: none;">You have successfully Registered!</span>
        </div>
...
-->
      ...
      <?php include('errors.php'); ?>
        ...
        <br>
        <div class="formGroup">
          <span class="message" style="color:white;font-size:15px;font-style:italic">Not a member? <a style="color:white;"href="Signin.php">Signin Here</a> </span>
        </div>
